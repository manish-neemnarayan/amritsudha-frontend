...
const AboutUs = function() {
    return(
        <>
        <section className="text-gray-600 body-font bg-orange-50 mt-2">
        <div className="container px-5 py-24 mx-auto md:width-full md:shadow-sm shadow-xl">
            <div className="flex flex-col text-center w-full mb-20">
            <h1 className="text-3xl font-medium title-font mb-4 text-gray-900 tracking-widest">OUR <span className="text-orange-500">TEAM</span></h1>
            ...
            <div className="p-4 lg:w-1/2">
                ...
                <div className="flex-grow sm:pl-8">
                    ...
                    <h3 className="text-orange-500 mb-3">UI Developer</h3>
            ...
            <div className="p-4 lg:w-1/2">
                ...
                <div className="flex-grow sm:pl-8">
                    ...
                    <h3 className="text-orange-500 mb-3">Designer</h3>
                    <p className="mb-4">DIY tote bag drinking vinegar cronut adaptogen squid fanny pack vaporware.</p>
                    <span className="inline-flex">
                    <a href="/" className="text-gray-500">
                        <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
        ...
        <div className="container px-5 py-24 mx-auto flex flex-wrap flex-col">
            <h2 className="text-3xl font-medium title-font mb-12 text-gray-900 tracking-widest text-center">Message from <span className="text-orange-500">CHAIRMAN</span></h2>
